...
function gravit_scripts() {
	wp_enqueue_style( 'gravit-style', get_stylesheet_uri(), array(), '1.0.0' );
...
function gravit_add_editor_styles() {
	...
	$font_url = '//fonts.googleapis.com/css?family=PT+Sans:400,700|Open+Sans';
...
function gravit_styles_method() {
	...
	if ( true == get_theme_mod( 'remove_space' ) ) {
		$custom_css .= "
				article:first-child {

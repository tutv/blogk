	...
	<?php } ?>
		...
		<header class="entry-header">
			<div class="bio-avatar">
				<span><a title="<?php _e('Show Posts from ', 'gravit'); the_author_meta('display_name'); ?>" href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ) ?>"><?php echo get_avatar( get_the_author_meta( 'ID' ) ); ?></a></span>
			</div>

...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header">
		...
		<div class="post-symbol">
			<i title="<?php _e('Standard Post', 'gravit') ?>" class="fa fa-thumb-tack"></i>
		</div>
	...
	<div class="entry-content">
		<?php the_content( __( 'Đọc tiếp <span class="meta-nav"><i class="fa fa-chevron-circle-right"></i></span>', 'gravit' ) ); ?>
